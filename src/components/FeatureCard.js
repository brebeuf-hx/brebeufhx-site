...
class FeatureCard extends BaseComponent {
    ...
    render() {
        ...
        this.innerHTML = /*html*/`
        <div class="overflow-hidden relative p-8 bg-ice-blue-50 rounded-lg border backdrop-blur-sm transition-all duration-500 transform hover:scale-105 border-ice-blue-100/50 group hover:-translate-y-2">
